...
========================
Dual-pass OCR using azure-ai-documentintelligence==1.0.2
Correct API syntax for version 1.0.2 (stable release).
...
def extract_text_per_page(
    ...
    try:
        ...
        # Version 1.0.2 requires base64 encoded bytes via AnalyzeDocumentRequest
        import base64
